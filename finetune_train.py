...
def train(args: Namespace):
    ...
    artifact_model = MODELS[model_type].load_from_checkpoint(modeller_path)
    model = make_model(args, datamodule.observation_space, datamodule.action_space)
    model.load_state_dict(artifact_model.state_dict())
