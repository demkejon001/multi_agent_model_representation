...
from src.agent_modellers.modeller_inputs import GridworldToMnetInput
from src.agent_modellers.modeller_outputs import ToMnetPredictions
from src.helper_code.conv import Conv2DRes
from src.agent_modellers.tomnet_base import AgentModeller, LSTMCharacterNet, LSTMMentalNet, TTXCharacterNet, \
    TTXMentalNet
...
class GridworldToMNet(AgentModeller):
    ...
    def forward(self, x: GridworldToMnetInput, return_embeddings=False):
        ...
        predictions = ToMnetPredictions(pred_action, pred_goal, None)
