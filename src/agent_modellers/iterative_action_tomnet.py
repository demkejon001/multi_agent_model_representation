...
from src.agent_modellers.tomnet_base import AgentModeller, LSTMCharacterNet, LSTMMentalNet, TTXCharacterNet, \
    TTXMentalNet
from src.agent_modellers.modeller_inputs import IterativeActionToMnetInput
...
class IterativeActionPastCurrentNet(AgentModeller):
    ...
    def forward(self, x: IterativeActionToMnetInput, return_embeddings=False):
        ...
        predictions = IterativeActionToMnetPredictions(self.action_pred_net(mental_embeddings))
