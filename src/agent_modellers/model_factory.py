...
from src.agent_modellers.gridworld_tomnet import GridworldToMNet
from src.agent_modellers.iterative_action_tomnet import IterativeActionToMnet
from src.data.datamodule_factory import get_datasets_abbreviation_str


MODELS = {"iterative_action_tomnet": IterativeActionToMnet,
...
def make_model(args: Union[Namespace, dict], observation_space, action_space):
    ...
    model_factory_fn = {"iterative_action_tomnet": make_iterative_action_tomnet,
...
def get_model_name(args: Namespace):
    model_name_abbreviations = {"iterative_action_past_current": "IterTNet",
...
def make_iterative_action_tomnet(args: Namespace, observation_space, action_space):
